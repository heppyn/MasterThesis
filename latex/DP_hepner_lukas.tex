...
kompresePokud se v políčku tabulky nachází dva biotopy, generátor z nich vybere jeden, pomocí 2D šumu a pozice na mapě. Biotopy by měly pokrývat velké oblasti terénu. Je proto nutné zvolit vhodné měřítko šumu, aby nedocházelo k opakovaným změnám biotopů v jedné oblasti.
...
\todo{je rozlozeni s oriznutymi obrazky lepsi?}
