...
\todo{Zpracovat sekci o stinovani}
Obrázek se stíny~\ref{fig:shadows}

\begin{figure}\centering
	\includegraphics[width=\textwidth]{images/shadows}
	\caption[Vykreslení stínů]{Vykreslení stínů}\label{fig:shadows}
\end{figure}
