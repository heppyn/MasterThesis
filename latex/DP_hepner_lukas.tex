...
Každý chunk obsahuje dvě pole herních objektů, rozdělené na průhledné a neprůhledné. Herní objekty se mohou překrývat -- z důvodu úspory paměti nejsou rozděleny na sub-voxely, které se nepřekrývají.
