...
\keywordsCS{
vykreslovací engine, voxelová grafika, OpenGL, procedurální generování, L-systémy
}
\keywordsEN{
rendering engine, voxel graphics, OpenGL, procedural generation, L-systems
}
...
K měření výkonu byla použita dvě zařízení, jejichž parametry jsou zobrazeny v tabulce~\ref{tab:hw}.
